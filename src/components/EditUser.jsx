...
import { SET_IS_EDIT_USER,IS_ALERT } from "../context/actions"
  ...
  return (
    ...
    ?<div>
      ...
      <Box sx={{ borderBottom: 1, borderColor: "divider" }}>
        ...
        >
          <Tab label="User Setting" {...a11yProps(0)} />
          <Tab label="Posts" {...a11yProps(1)} />
        </Tabs>
      </Box>
      <TabPanel value={value} index={0}>
      <UserDetail user={user}></UserDetail>
      <UserStetting user={user}></UserStetting>
      </TabPanel>
      <TabPanel value={value} index={1}>
       <PostSetting user= {user}></PostSetting>
      </TabPanel>
      </Box>
      </Dialog>
    </div>
